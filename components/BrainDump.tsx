...
export default function BrainDump() {
  ...
  return (
    <div className="mt-6 w-full">
      ...
      <textarea
        className="resize-none w-full mt-2 p-2.5 block text-gray-900 border-2 border-slate-800 rounded-sm bg-gray-50 h-96 dark:bg-slate-700 dark:border-slate-300 dark:text-slate-100"
        name="0"
        id="brainDump"
